    ...
    4. Enter tethys test command.
       ...
       See below for specific examples
        ...
        To run all tests across this app:
            Test command: "tethys test -f tethys_apps.tethysapp.lis_explorer"

        To run all tests in this file:
            Test command: "tethys test -f tethys_apps.tethysapp.lis_explorer.tests.tests"

        To run tests in the LisExplorerTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.lis_explorer.tests.tests.LisExplorerTestCase"

        To run only the test_if_tethys_platform_is_great function in the LisExplorerTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.lis_explorer.tests.tests.LisExplorerTestCase.test_if_tethys_platform_is_great"
...
class LisExplorerTestCase(TethysTestCase):
    """
    ...
    def set_up(self):
        ...
        test database creation function here, like so:
            ...
            self.create_test_persistent_stores_for_app(LisExplorer)
    ...
    def tear_down(self):
        ...
        stores, you should call the test database destruction function from here, like so:
            ...
            self.destroy_test_persistent_stores_for_app(LisExplorer)
    ...
    def test_home_controller(self):
        ...
        response = c.get('/apps/lis-explorer/')  # The final '/' is essential for all pages/controllers
